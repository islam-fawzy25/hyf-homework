...
function generateListings(numberOfListings) {
 ...
 generateListings(20);
/*
console.log(generateListings(53))
const listOf = generateListings(7)
listOf.forEach(function(list){
console.log(list.size) 
})

const listOfPrices = listOf.map (list   => list.price  )
*/
...
//console.log(listings) 
   ...
   //type: 'farm';
   const typeFilter =  listings.filter(item => item.type=='Farm');
   //    minPrize: 1500000,
const priceFilter = typeFilter.filter(price => price.price>= 1500);
